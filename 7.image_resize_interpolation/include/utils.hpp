...
void init_matrix_float(float* A, int m, int n, float min_val, float max_val, int seed);  // 初始化介于a, b之间的随机浮点数
void print_matrix(float* A, int m, int n);    // 打印矩阵
void compare_matrix(float* A, float* B, int m, int n);    // 比较两个矩阵是否相同
