...
int main() {
    ...
    matrix_mul_gpu(M_host, N_host, P_by_device, width, block_size);
    timer.stop_gpu();
    timer.duration_gpu("matmul in gpu general(block size=16)");
    ...
    timer.stop_gpu();
    timer.duration_gpu("matmul in gpu with static shared memory(block size=16)");
    compare_matrix(P_by_host, P_by_device, width, width);
    ...
    timer.stop_gpu();
    timer.duration_gpu("matmul in gpu with static shared memory with bank conflict(block size=16)");
    compare_matrix(P_by_host, P_by_device, width, width);
    ...
    timer.stop_gpu();
    timer.duration_gpu("matmul in gpu with static shared memory with bank conflict pad(block size=16)");
    compare_matrix(P_by_host, P_by_device, width, width);
    ...
    matrix_mul_gpu_shared(M_host, N_host, P_by_device, width, block_size, use_shared_memory);
    timer.stop_gpu();
    timer.duration_gpu("matmul in gpu with dynamic shared memory(block size=16)");
    compare_matrix(P_by_host, P_by_device, width, width);
    ...
    matrix_mul_gpu_shared_with_bank_conflict(M_host, N_host, P_by_device, width, block_size, use_shared_memory);
    timer.stop_gpu();
    timer.duration_gpu("matmul in gpu with dynamic shared memory with bank conflict(block size=16)");
    compare_matrix(P_by_host, P_by_device, width, width);
    ...
    matrix_mul_gpu_shared_with_conflict_pad(M_host, N_host, P_by_device, width, block_size, use_shared_memory);
    timer.stop_gpu();
    timer.duration_gpu("matmul in gpu with dynamic shared memory with bank conflict pad(block size=16)");
    compare_matrix(P_by_host, P_by_device, width, width);
    ...
    matrix_mul_gpu(M_host, N_host, P_by_device, width, block_size);
    timer.stop_gpu();
    timer.duration_gpu("matmul in gpu general(block size=32)");
    compare_matrix(P_by_host, P_by_device, width, width);
    ...
    matrix_mul_gpu_shared(M_host, N_host, P_by_device, width, block_size, use_shared_memory);
    timer.stop_gpu();
    timer.duration_gpu("matmul in gpu with dynamic shared memory(block size=32)");
    compare_matrix(P_by_host, P_by_device, width, width);
    ...
    matrix_mul_gpu_shared_with_bank_conflict(M_host, N_host, P_by_device, width, block_size, use_shared_memory);
    timer.stop_gpu();
    timer.duration_gpu("matmul in gpu with dynamic shared memory with bank conflict(block size=32)");
    compare_matrix(P_by_host, P_by_device, width, width);
    ...
    matrix_mul_gpu_shared_with_conflict_pad(M_host, N_host, P_by_device, width, block_size, use_shared_memory);
    timer.stop_gpu();
    timer.duration_gpu("matmul in gpu with dynamic shared memory with bank conflict pad(block size=32)");
    compare_matrix(P_by_host, P_by_device, width, width);
    ...
    */
    ...
    // matrix_mul_gpu(M_host, N_host, P_by_device, width, block_size);
    // timer.stop_gpu();
    // timer.duration_gpu("matmul in gpu (block size=64)");
